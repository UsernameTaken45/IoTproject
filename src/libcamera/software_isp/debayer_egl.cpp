...
void DebayerEGL::setShaderVariableValues(DebayerParams &params)
{
	...
	//LSC
	egl_.createTexture2D(*eglImageLSCLookupRed_, GL_LUMINANCE, 16, 16, &params.lscRed, GL_LINEAR);
	egl_.createTexture2D(*eglImageLSCLookupBlue_, GL_LUMINANCE, 16, 16, &params.lscGreen, GL_LINEAR);
	egl_.createTexture2D(*eglImageLSCLookupGreen_, GL_LUMINANCE, 16, 16, &params.lscBlue, GL_LINEAR);
